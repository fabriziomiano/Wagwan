...
def wordcount(conf):
    ...
    wc_plot_filepath = os.path.join(PUBLIC_DIR, plots_dir_path, wc_plot_filename)
    ...
    columns = ["word", "count"]
    data_to_tsv(wordcount_data, columns, os.path.join(app.root_path, data_filepath))
    ...
    save_barplot(wordcount_data, plot_labels, n_top_words, os.path.join(app.root_path, barplot_filepath))
    ...
    p.save_wordcloud_plot(os.path.join(app.root_path, wc_plot_filepath))
